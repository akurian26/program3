...
public int overallScore()
{
   ...
   if (score1 < score2 && score1 < score3) {
      ...
      s1 = score1;
      s2 = score3; //changed this line from s2 = score2 to s2 = score3 since in this case score3 is greater than score2
...
//added the following code so that the intended purpose of the 
//function would still be achieved in cases when there were
//two scores that were equal
...
{
   int s1, s2, s3;
//unable to test for a branch here
//unable to pass values in such a way that args would be null
