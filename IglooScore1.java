...
{
   int s;
   //changed the statements under if from s = score2 to s = score1
   //also changed statement under else from s = score1 to s = score2 
   //this way, if score1 is less than score2 then score1 will be removed
   //and vice versa if score1 is not less than score2
   if (score1 < score2)
      s = score1;
   else
      s = score2;
